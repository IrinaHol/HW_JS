...
//
// div.classList.add('articwrap', 'collapse', 'alpha', 'betale');
...
//     let div = document.createElement('div');
//     div.innerHTML = `title: ${item.title} </br> monthDuration: ${item.monthDuration}`;
//     document.body.appendChild(div);
// }
...
//     div.innerHTML = `${simpson.name} ${simpson.surname} </br> ${simpson.age} </br> ${simpson.info}`;
